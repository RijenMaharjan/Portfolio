...
const BIO_SHORT = "Backend developer from Kathmandu, Nepal. I build efficient and scalable applications, turning ideas into functional systems, and enjoy creating solutions that make an impact.";
const BIO_LONG = `I’m Rijen Maharjan, a backend developer and BIM student from Kathmandu. 
I build robust and scalable applications, turning complex problems into functional systems and designing solutions that make an impact.

I have experience creating projects like restaurant management systems, automation tools, and SaaS backends, focusing on writing clean, modular code that is efficient, maintainable, and reliable.
